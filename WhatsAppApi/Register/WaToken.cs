...
namespace WhatsAppApi.Register
{
    internal class WaToken
    {
        ...
        public static string GenerateTokenAndroid(string number)
        {
            ...
            string classesMd5 = "ry9Xz6kVioQctwA3G9z62Q=="; // 2.12.556

            string key2 = Base64Decode("eQV5aq/Cg63Gsq1sshN9T3gh+UUp0wIw0xgHYT1bnCjEqOJQKCRrWxdAe2yvsDeCJL+Y4G3PRD2HUF7oUgiGo8vGlNJOaux26k+A2F3hj8A=", Encoding.GetEncoding(28591));
            string data = Base64Decode(signature, Encoding.GetEncoding(28591)) + Base64Decode(classesMd5, Encoding.GetEncoding(28591)) + number;
