...
namespace WhatsAppApi.Parser
{
    public class FMessage
    {
        ...
        public class Builder
        {
            ...
            public FMessage.Builder FromMe(bool from_me)
            {
            ...
            public FMessage.Builder LocationDetails(string details)
            {
            ...
            public FMessage.Builder LocationUrl(string url)
            {
            ...
            public FMessage.Builder MediaDurationSeconds(int media_duration_seconds)
            {
            ...
            public FMessage.Builder MediaName(string media_name)
            {
            ...
            public FMessage.Builder MediaSize(long media_size)
            {
            ...
            public FMessage.Builder MediaUrl(string media_url)
            {
                this.media_url = media_url;
                return this;
            }

            public FMessage.Type? MediaType()
            {
                return this.media_wa_type;
            }

            public FMessage.Builder MediaType(FMessage.Type media_wa_type)
            {
            ...
            public FMessage.Builder NewIncomingInstance()
            {
                ...
                this.message = new FMessage(new FMessage.FMessageIdentifierKey(this.remote_jid, this.from_me.Value, this.id));
                return this;
            }
            ...
            public FMessage.Builder RemoteJID(string remote_jid)
            {
            ...
            public FMessage.Builder RemoteResource(string remote_resource)
            {
            ...
            public FMessage.Builder ThumbImage(string thumb_image)
            {
            ...
            public FMessage.Builder WantsReceipt(bool wants_receipt)
            {
